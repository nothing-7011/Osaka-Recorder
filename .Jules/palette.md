...
## 2024-06-02 - [Overlay Text Extraction]
**Learning:** System overlays with `FLAG_NOT_FOCUSABLE` prevent native text selection, making content trapped unless explicit extraction tools are provided.
**Action:** Always include a dedicated "Copy" button (using `LocalClipboardManager`) for text content within non-focusable overlay windows.
